...
public class ParcelDto {
    ...
    public static class ParcelDtoBuilder {
        ...
        public ParcelDtoBuilder size(ParcelStatusDto size) {
            this.size = size;
            return this;
        }
    ...
    private ParcelDto(String parcelId, ParcelStatusDto status, String senderCity, String senderPostCode, String senderStreet, String receiverCity,
                      String receiverPostCode, String receiverStreet, int weightInKg, int height, int length, int width, ParcelStatusDto size, Duration timeToDeliver) {
        this.parcelId = parcelId;
        this.status = status;
        this.senderCity = senderCity;
        this.senderPostCode = senderPostCode;
